...
//  );
//  return true;
$config['ldap_uri'] = array('ldap://indonet.co.id:389/');
// $config ['ldap_uri'] = array('ldaps://ldap.mycompany.com:636/');  <-- connect via SSL
//$config['use_tls'] = true; // Encrypted without using SSL
$config['search_base'] = 'dc=co,dc=id';
$config['user_search_base'] = array('ou=people,dc=indonet,dc=co,dc=id');  // Leave empty to use $config['search_base']
$config['group_search_base'] = array('ou=group,dc=indonet,dc=co,dc=id');  // Leave empty to use $config['search_base']
...
$config['schema_type'] = 'uSb5tRfD'; // Use rfc2307, rfc2307bis, or ad
//$config['proxy_user'] = '';
//$config['proxy_pass'] = '';
