...
<div id="DataTables_Table_0_wrapper" class="dataTables_wrapper no-footer">
    <div class="datatable-header">
        <div class="dataTables_filter">
            <div class="btn-group">
                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal_form_bse">Add <i class="icon-play3 position-right"></i></button>
            </div>
            <div class="btn-group">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <input type="text" id="id_bse" name="id_bse" maxlength="19" placeholder="" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <input type="text" id="id_bse_map" name="id_bse_map" maxlength="19" placeholder="" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
